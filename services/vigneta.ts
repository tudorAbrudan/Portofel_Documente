...
export const VIGNETA_COUNTRIES: VignetaCountry[] = [
  {
    ...
    name: 'Austria',
    required: true,
    validityOptions: ['10 zile', '2 luni', '1 an'],
    buyUrl: 'https://www.asfinag.at/toll/vignette/',
  },
  {
    code: 'CH',
    name: 'Elveția',
    required: true,
    validityOptions: ['1 an'],
    buyUrl: 'https://www.ch.ch/en/motorway-vignette/',
  },
  {
    code: 'CZ',
    name: 'Cehia',
    required: true,
    validityOptions: ['1 zi', '10 zile', '1 lună', '1 an'],
    buyUrl: 'https://edalnice.cz/en/',
  },
  {
    code: 'SK',
    name: 'Slovacia',
  ...
  },
  {
    ...
    required: true,
    validityOptions: ['1 zi', '10 zile', '1 lună', '1 an'],
    buyUrl: 'https://ematrica.nemzetiutdij.hu/ugyintezesek/vignette_purchase',
  },
  {
    code: 'SI',
    name: 'Slovenia',
    required: true,
    validityOptions: ['7 zile', '1 lună', '6 luni', '1 an'],
    buyUrl: 'https://evinjeta.dars.si/en',
  },
  {
    code: 'RO',
    name: 'România',
    required: true,
    validityOptions: ['7 zile', '1 lună', '3 luni', '1 an'],
    note: 'Rovinieta',
    buyUrl: 'https://www.roviniete.ro/ro/cumpara-rovinieta/',
  },
  {
    code: 'BG',
    name: 'Bulgaria',
    required: true,
    validityOptions: ['1 zi', '7 zile', '1 lună', '1 an'],
    buyUrl: 'https://bgtoll.bg/en/',
  },
  {
    code: 'HR',
    name: 'Croația',
    required: false,
    validityOptions: [],
    note: 'Taxă per kilometru pe autostradă (nu vignetă)',
  },
  ...
  { code: 'LU', name: 'Luxemburg', required: false, validityOptions: [] },
  {
    ...
    required: false,
    validityOptions: [],
    note: 'Taxe electronice Via Verde',
  },
