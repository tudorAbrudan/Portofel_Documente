...
export const VIGNETA_COUNTRIES: VignetaCountry[] = [
  { code: 'AT', name: 'Austria', required: true, validityOptions: ['10 zile', '2 luni', '1 an'] },
  { code: 'CH', name: 'Elveția', required: true, validityOptions: ['1 an'] },
  { code: 'CZ', name: 'Cehia', required: true, validityOptions: ['1 zi', '10 zile', '1 lună', '1 an'] },
  { code: 'SK', name: 'Slovacia', required: true, validityOptions: ['1 zi', '10 zile', '1 lună', '1 an'] },
  { code: 'HU', name: 'Ungaria', required: true, validityOptions: ['1 zi', '10 zile', '1 lună', '1 an'] },
  { code: 'SI', name: 'Slovenia', required: true, validityOptions: ['7 zile', '1 lună', '6 luni', '1 an'] },
  { code: 'RO', name: 'România', required: true, validityOptions: ['7 zile', '1 lună', '3 luni', '1 an'], note: 'Rovinieta' },
  { code: 'BG', name: 'Bulgaria', required: true, validityOptions: ['1 zi', '7 zile', '1 lună', '1 an'] },
